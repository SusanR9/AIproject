...
class Registration(models.Model):
    ...
    candidate_photo = models.FileField(
        db_column='candidate_photo',
    ...
    competition_name = models.CharField(
        db_column='Competition_name',
        max_length=100,
        null=True,
        blank=True
    )

    type_of_enroll = models.CharField(
        db_column='Type_of_Enroll',
        max_length=100,
        null=True,
        blank=True
    )
